...
(defun init-keyboard-options ()
  ...
  (when (optionp 'god-mode)
    ...
    (define-key god-local-mode-map (kbd "S-h")      'left-char)
    (define-key god-local-mode-map (kbd "S-j")      'next-line)
    (define-key god-local-mode-map (kbd "S-k")      'previous-line)
    (define-key god-local-mode-map (kbd "S-l")      'right-char)
    (define-key god-local-mode-map (kbd "M-h")      'backward-sexp)
    (define-key god-local-mode-map (kbd "M-j")      'down-list)
    (define-key god-local-mode-map (kbd "M-k")      'backward-up-list)
    (define-key god-local-mode-map (kbd "M-l")      'forward-sexp)
    (define-key god-local-mode-map (kbd "M-S-h")    'backward-sexp)
    (define-key god-local-mode-map (kbd "M-S-j")    'forward-paragraph)
    (define-key god-local-mode-map (kbd "M-S-k")    'backward-paragraph)
    (define-key god-local-mode-map (kbd "M-S-l")    'forward-sexp)
    ...
    (define-key god-local-mode-map (kbd "C-S-h")    'backward-sexp)
    (define-key god-local-mode-map (kbd "C-S-j")    'forward-paragraph)
    (define-key god-local-mode-map (kbd "C-S-k")    'backward-paragraph)
    (define-key god-local-mode-map (kbd "C-S-l")    'forward-sexp)
    (define-key god-local-mode-map (kbd "C-M-S-h")  'backward-sexp)
    (define-key god-local-mode-map (kbd "C-M-S-j")  'forward-paragraph)
    (define-key god-local-mode-map (kbd "C-M-S-k")  'backward-paragraph)
    (define-key god-local-mode-map (kbd "C-M-S-l")  'forward-sexp)
